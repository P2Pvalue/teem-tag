...
_SparseReshapeOutput = collections.namedtuple("SparseReshape",
...
_SparseSparseMaximumOutput = collections.namedtuple("SparseSparseMaximum",
...
_SparseSparseMinimumOutput = collections.namedtuple("SparseSparseMinimum",
