...
_RUNOPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='debug_tensor_watch_opts', full_name='tensorflow.RunOptions.debug_tensor_watch_opts', index=3,
...
_RUNOPTIONS.fields_by_name['debug_tensor_watch_opts'].message_type = _DEBUGTENSORWATCH
