...
def batch_cholesky(input, name=None):
  r"""Computes the Cholesky decomposition of a batch of square matrices.
...
def batch_matrix_determinant(input, name=None):
  r"""Computes the determinants for a batch of square matrices.
...
def batch_matrix_inverse(input, adjoint=None, name=None):
  r"""Computes the inverse of square invertible matrices or their adjoints
...
_BatchSelfAdjointEigV2Output = collections.namedtuple("BatchSelfAdjointEigV2",
                                                      _batch_self_adjoint_eig_v2_outputs)


def batch_self_adjoint_eig_v2(input, compute_v=None, name=None):
  r"""Computes the eigen decomposition of a batch of square self-adjoint matrices.
...
_BatchSvdOutput = collections.namedtuple("BatchSvd", _batch_svd_outputs)


def batch_svd(input, compute_uv=None, full_matrices=None, name=None):
  r"""Computes the singular value decompositions of a batch of matrices.
...
def cholesky(input, name=None):
  r"""Computes the Cholesky decomposition of a square matrix.
...
def matrix_determinant(input, name=None):
  r"""Computes the determinant of a square matrix.
...
def matrix_inverse(input, adjoint=None, name=None):
  r"""Computes the inverse of a square invertible matrix or its adjoint (conjugate
...
def self_adjoint_eig(input, name=None):
  r"""Computes the Eigen Decomposition of a square Self-Adjoint matrix.
...
_SelfAdjointEigV2Output = collections.namedtuple("SelfAdjointEigV2",
                                                 _self_adjoint_eig_v2_outputs)


def self_adjoint_eig_v2(input, compute_v=None, name=None):
  r"""Computes the eigen decomposition of a self-adjoint (\"symmetric\") matrix.
...
_SvdOutput = collections.namedtuple("Svd", _svd_outputs)


def svd(input, compute_uv=None, full_matrices=None, name=None):
  r"""Computes the singular value decomposition of a matrix.
