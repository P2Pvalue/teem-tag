...
def TF_Reset_wrapper(*args):
  return _pywrap_tensorflow.TF_Reset_wrapper(*args)
...
def DoQuantizeTrainingOnGraphDefHelper(*args):
  return _pywrap_tensorflow.DoQuantizeTrainingOnGraphDefHelper(*args)
...
def CopyFile(*args):
  return _pywrap_tensorflow.CopyFile(*args)
CopyFile = _pywrap_tensorflow.CopyFile

def RenameFile(*args):
  return _pywrap_tensorflow.RenameFile(*args)
RenameFile = _pywrap_tensorflow.RenameFile

def DeleteRecursively(*args):
  return _pywrap_tensorflow.DeleteRecursively(*args)
DeleteRecursively = _pywrap_tensorflow.DeleteRecursively

def IsDirectory(*args):
  return _pywrap_tensorflow.IsDirectory(*args)
IsDirectory = _pywrap_tensorflow.IsDirectory

def Stat(*args):
  return _pywrap_tensorflow.Stat(*args)
Stat = _pywrap_tensorflow.Stat

def JoinPath(*args):
  return _pywrap_tensorflow.JoinPath(*args)
JoinPath = _pywrap_tensorflow.JoinPath

def IsAbsolutePath(*args):
  return _pywrap_tensorflow.IsAbsolutePath(*args)
IsAbsolutePath = _pywrap_tensorflow.IsAbsolutePath

def Dirname(*args):
  return _pywrap_tensorflow.Dirname(*args)
Dirname = _pywrap_tensorflow.Dirname

def Basename(*args):
  return _pywrap_tensorflow.Basename(*args)
Basename = _pywrap_tensorflow.Basename

def Extension(*args):
  return _pywrap_tensorflow.Extension(*args)
...
class FileStatistics(_object):
    ...
    if _newclass:length = _swig_property(_pywrap_tensorflow.FileStatistics_length_get, _pywrap_tensorflow.FileStatistics_length_set)
    ...
    if _newclass:mtime_nsec = _swig_property(_pywrap_tensorflow.FileStatistics_mtime_nsec_get, _pywrap_tensorflow.FileStatistics_mtime_nsec_set)
    __swig_setmethods__["mode"] = _pywrap_tensorflow.FileStatistics_mode_set
    __swig_getmethods__["mode"] = _pywrap_tensorflow.FileStatistics_mode_get
    if _newclass:mode = _swig_property(_pywrap_tensorflow.FileStatistics_mode_get, _pywrap_tensorflow.FileStatistics_mode_set)
    def __init__(self): 
